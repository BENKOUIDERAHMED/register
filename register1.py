...
class AppointmentApp:
    def __init__(self, root):
        self.root = root
        self.root.title("برنامج إدارة المواعيد")
    ...
    def create_top_bar(self):
        top_bar = tk.Frame(self.root, bg="#c5d6e2", height=40)
        ...
        # Placeholder for top icons/buttons
    ...
    def create_main_content(self):
        ...
        buttons_frame = tk.Frame(main_frame, bg=self.root['bg'])
    ...
    def update_time(self):
        ...
        arabic_day = {"Saturday": "السبت", "Sunday": "الأحد", "Monday": "الإثنين", "Tuesday": "الثلاثاء", "Wednesday": "الأربعاء", "Thursday": "الخميس", "Friday": "الجمعة"}
    ...
    def view_images(self):
        print("عرض الصور...")
        # Placeholder for image viewing functionality

    def right_align_text(self, event):
        """Applies RTL justification to the text widget."""
        widget = event.widget
    ...
    def add_widget(self, parent, field_name, widget_type, row, is_note=False, **kwargs):
        ...
        if widget_type == 'entry':
            ...
            # Configure a tag for right justification
            widget.tag_configure("rtl", justify='right')
            # Bind the KeyRelease event to update the justification
    ...
    def create_buttons(self, parent):
        button_container = tk.Frame(parent, bg=self.root['bg'])
